        ...
        <M.Layout>
          <M.setReactionContainer>
            <M.DetailTitleWrapper>
              고마움 남기기{" "}
              <M.DoneBtn onClick={() => setPage("done")}>완료</M.DoneBtn>
            </M.DetailTitleWrapper>
            <M.EmojiContainer>
              <Emoji1 onClick={() => handleEmojiClick(<Emoji1 />)} />
              <Emoji2 onClick={() => handleEmojiClick(<Emoji2 />)} />
              <Emoji3 onClick={() => handleEmojiClick(<Emoji3 />)} />
              <Emoji4 onClick={() => handleEmojiClick(<Emoji4 />)} />
              <Emoji5 onClick={() => handleEmojiClick(<Emoji5 />)} />
            </M.EmojiContainer>
          </M.setReactionContainer>
        </M.Layout>
      );
